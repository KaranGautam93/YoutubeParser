    ...
    <div style="margin-top: 10px;">
        <div class="row">
            <div class="col s12 m8 l8">
                ...
                <div><span id="videoTitle" style="font-weight: bold;"></span>
            ...
            <div class="col s12 m4 l4 channel-card" style="display: none">
                <div class="card medium pull-right" style=" width: 100%;margin-top: 0px;">
                    <div class="card-image waves-effect waves-block waves-light"
                         style="background-color: #383d41;text-align: center">
                        <img style="border-radius: 100%;max-height: 200px; max-width: 200px;margin-left: 25%"
                             class="activator channel-image" src="">
                    </div>
                    <div class="card-content">
                        <span class="card-title activator grey-text text-darken-4" style="font-weight: bold;">About this Channel<i
                ...
                function fetchVideoDetails() {
                    ...
                    $.ajax({
                        ...
                        error: function (error) {
                            $(".loader-div").hide();
                            swal("", "We didn't find this video in our system.", "error")
                                .then((response) => {
                                    if (response) {
